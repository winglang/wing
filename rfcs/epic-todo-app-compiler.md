...
let counter = new cloud.Counter();
   ...
   */
  inflight function add_task(title: str): str {
    let id = "${counter.inc()}";
   ...
   */
  inflight function get_task(id: str): str {
   ...
   */
  inflight function remove_task(id: str) {
    ...
    */
  inflight function list_task_ids(): Set<str> {
    return bucket.list();
  }
    ...
    */
  inflight function find_tasks_with(term: str): Set<str> {
