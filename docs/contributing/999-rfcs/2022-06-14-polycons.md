...
> Please check out the polycons [README](https://github.com/winglang/polycons) for details about how the current Polycons API works, and check the [SDK Architecture](/contributing/wingsdk#sdk-architecture) to see where many ideas from this RFC were adopted!
