...
> **Note:** polycons was an early design for how to support CDK constructs that work across multiple cloud targets.
> It has since been deprecated to [https://github.com/winglang/polycons], but we've kept the RFC here for historical value. Check out the [SDK Architecture](../start-here/wingsdk#sdk-architecture) to see where many ideas from this RFC were adopted!
