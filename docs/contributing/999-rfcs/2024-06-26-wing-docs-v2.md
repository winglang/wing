...
These developers are consumers of wing libs and the wing standard library. They are part of stream aligned teams focused on the problem domain of the users of the business, not necessarily worried about infrastructure and operate with abstractions into the cloud.
