...
4. Wing provides local simulation and visualization [tools](https://docs.winglang.io/start-here/local) that let you develop locally with instant hot reloading. With the CDK, you must deploy to the cloud in order to interact with your application, which can take several minutes.
