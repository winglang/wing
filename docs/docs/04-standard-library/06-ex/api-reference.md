...
| <code><a href="#@winglang/sdk.ex.IDynamodbTableClient.query">query</a></code> | Returs all items with a given partition key value. |
...
| <code><a href="#@winglang/sdk.ex.DynamodbTableClientBase.query">query</a></code> | Returs all items with a given partition key value. |
