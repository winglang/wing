---
title: Dynamodb Table interfaces
id: dynamodb-table-interfaces
description: A set of interfaces used with dynamoDb client.
...
<<<<<<< HEAD:docs/docs/04-standard-library/ex/dynamodb-table.md
...
=======
>>>>>>> main:docs/docs/04-standard-library/ex/dynamodb-table/interfaces.md
