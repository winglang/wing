...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@winglang/sdk.ex.ReactApp.onLiftType">onLiftType</a></code> | A hook called by the Wing compiler once for each inflight host that needs to use this type inflight. |

---

##### `onLiftType` <a name="onLiftType" id="@winglang/sdk.ex.ReactApp.onLiftType"></a>
...
###### `host`<sup>Required</sup> <a name="host" id="@winglang/sdk.ex.ReactApp.onLiftType.parameter.host"></a>

- *Type:* <a href="#@winglang/sdk.std.IInflightHost">IInflightHost</a>

---

###### `ops`<sup>Required</sup> <a name="ops" id="@winglang/sdk.ex.ReactApp.onLiftType.parameter.ops"></a>
