...
### LogType <a name="LogType" id="@winglang/sdk.cloud.LogType"></a>

Cloud Function log type (currently implemented only for tf-aws and awscdk targets.).

#### Members <a name="Members" id="Members"></a>

| **Name** | **Description** |
| --- | --- |
| <code><a href="#@winglang/sdk.cloud.LogType.NONE">NONE</a></code> | No function logs will be displayed. |
| <code><a href="#@winglang/sdk.cloud.LogType.DEFAULT">DEFAULT</a></code> | Only the user created logs will be displayed. |
| <code><a href="#@winglang/sdk.cloud.LogType.EXTENDED">EXTENDED</a></code> | All logs will be displayed, including those that are created by the cloud vendor. |

---

##### `NONE` <a name="NONE" id="@winglang/sdk.cloud.LogType.NONE"></a>
...
##### `DEFAULT` <a name="DEFAULT" id="@winglang/sdk.cloud.LogType.DEFAULT"></a>
...
##### `EXTENDED` <a name="EXTENDED" id="@winglang/sdk.cloud.LogType.EXTENDED"></a>
