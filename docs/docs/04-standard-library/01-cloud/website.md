...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@winglang/sdk.cloud.Website.addFile">addFile</a></code> | Add a file with custom value during the website's deployment. |
...
```wing
addFile(path: str, data: str, contentType: str): str
```
...
###### `contentType`<sup>Required</sup> <a name="contentType" id="@winglang/sdk.cloud.Website.addFile.parameter.contentType"></a>
