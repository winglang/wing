...
```wing
new TestRunner(props?: TestRunnerProps);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@winglang/sdk.std.TestRunner.Initializer.parameter.props">props</a></code> | <code><a href="#@winglang/sdk.std.TestRunnerProps">TestRunnerProps</a></code> | *No description.* |

---

##### `props`<sup>Optional</sup> <a name="props" id="@winglang/sdk.std.TestRunner.Initializer.parameter.props"></a>

- *Type:* <a href="#@winglang/sdk.std.TestRunnerProps">TestRunnerProps</a>
...
##### `findTests` <a name="findTests" id="@winglang/sdk.std.TestRunner.findTests"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@winglang/sdk.std.TestRunner.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#@winglang/sdk.std.TestRunner.property.display">display</a></code> | <code><a href="#@winglang/sdk.std.Display">Display</a></code> | Information on how to display a resource in the UI. |

---

##### `node`<sup>Required</sup> <a name="node" id="@winglang/sdk.std.TestRunner.property.node"></a>
...
##### `display`<sup>Required</sup> <a name="display" id="@winglang/sdk.std.TestRunner.property.display"></a>
...
### TestResult <a name="TestResult" id="@winglang/sdk.std.TestResult"></a>

A result of a single test.

#### Initializer <a name="Initializer" id="@winglang/sdk.std.TestResult.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@winglang/sdk.std.TestResult.property.pass">pass</a></code> | <code>bool</code> | Whether the test passed. |
| <code><a href="#@winglang/sdk.std.TestResult.property.path">path</a></code> | <code>str</code> | The path of the test. |
| <code><a href="#@winglang/sdk.std.TestResult.property.traces">traces</a></code> | <code>MutArray&lt;<a href="#@winglang/sdk.std.Trace">Trace</a>&gt;</code> | List of traces emitted during the test. |
| <code><a href="#@winglang/sdk.std.TestResult.property.error">error</a></code> | <code>str</code> | The error message if the test failed. |

---

##### `pass`<sup>Required</sup> <a name="pass" id="@winglang/sdk.std.TestResult.property.pass"></a>
...
##### `path`<sup>Required</sup> <a name="path" id="@winglang/sdk.std.TestResult.property.path"></a>
...
##### `traces`<sup>Required</sup> <a name="traces" id="@winglang/sdk.std.TestResult.property.traces"></a>

```wing
traces: MutArray<Trace>;
```

- *Type:* MutArray&lt;<a href="#@winglang/sdk.std.Trace">Trace</a>&gt;

List of traces emitted during the test.

---

##### `error`<sup>Optional</sup> <a name="error" id="@winglang/sdk.std.TestResult.property.error"></a>
...
### TestRunnerProps <a name="TestRunnerProps" id="@winglang/sdk.std.TestRunnerProps"></a>

Properties for `TestRunner`.

#### Initializer <a name="Initializer" id="@winglang/sdk.std.TestRunnerProps.Initializer"></a>

```wing
let TestRunnerProps = TestRunnerProps{ ... };
```


### Trace <a name="Trace" id="@winglang/sdk.std.Trace"></a>

A trace emitted during simulation.

#### Initializer <a name="Initializer" id="@winglang/sdk.std.Trace.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@winglang/sdk.std.Trace.property.data">data</a></code> | <code>any</code> | A JSON blob with structured data. |
| <code><a href="#@winglang/sdk.std.Trace.property.sourcePath">sourcePath</a></code> | <code>str</code> | The path of the resource that emitted the trace. |
| <code><a href="#@winglang/sdk.std.Trace.property.sourceType">sourceType</a></code> | <code>str</code> | The type of the source that emitted the trace. |
| <code><a href="#@winglang/sdk.std.Trace.property.timestamp">timestamp</a></code> | <code>str</code> | The timestamp of the event, in ISO 8601 format. |
| <code><a href="#@winglang/sdk.std.Trace.property.type">type</a></code> | <code><a href="#@winglang/sdk.std.TraceType">TraceType</a></code> | The type of a trace. |

---

##### `data`<sup>Required</sup> <a name="data" id="@winglang/sdk.std.Trace.property.data"></a>
...
##### `sourcePath`<sup>Required</sup> <a name="sourcePath" id="@winglang/sdk.std.Trace.property.sourcePath"></a>
...
##### `sourceType`<sup>Required</sup> <a name="sourceType" id="@winglang/sdk.std.Trace.property.sourceType"></a>
...
##### `timestamp`<sup>Required</sup> <a name="timestamp" id="@winglang/sdk.std.Trace.property.timestamp"></a>
...
##### `type`<sup>Required</sup> <a name="type" id="@winglang/sdk.std.Trace.property.type"></a>
...
### TraceType <a name="TraceType" id="@winglang/sdk.std.TraceType"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@winglang/sdk.std.TraceType.RESOURCE">RESOURCE</a></code> | A trace representing a resource activity. |
| <code><a href="#@winglang/sdk.std.TraceType.LOG">LOG</a></code> | A trace representing a message emitted by the logger. |

---

##### `RESOURCE` <a name="RESOURCE" id="@winglang/sdk.std.TraceType.RESOURCE"></a>
...
##### `LOG` <a name="LOG" id="@winglang/sdk.std.TraceType.LOG"></a>
