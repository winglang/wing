# 0013 - Polycons Framework

> Note: the design of polycons has changed significantly since this was first written!
> Please check out the polycons [README](https://github.com/winglang/polycons) for details about how the current Polycons API works, and check the [SDK Architecture](../docs/sdk-architecture.md) to see where many ideas from this RFC were adopted!
