...
class Foo {
  extern "./external_js.js" public static getGreeting(name: str): str;
  ...
  extern "./external_js.js" public static inflight print(msg: str);
  extern "uuid" public static v4(): str;

  public inflight call() {
