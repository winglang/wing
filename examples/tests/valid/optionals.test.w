...
let maybeDog: Dog? = bailey;
let dog: Dog = bailey;

let maybePet: Pet? = bailey;
let pet: Pet = bailey;

let takesDog = (d: Dog) => {};
let takesPet = (p: Pet) => {};
let takesMaybeDog = (d: Dog?) => {};
let takesMaybePet = (p: Pet?) => {};

let x1 = maybeDog ?? dog;      // Dog
let x2 = maybeDog ?? maybeDog; // Dog?
let x3 = maybeDog ?? pet;      // Pet
let x4 = maybeDog ?? maybePet; // Pet?
let x5 = maybePet ?? dog;      // Pet
let x6 = maybePet ?? maybeDog; // Pet?

let x7 = maybeDog ?? maybeDog ?? maybeDog ?? maybeDog; // Dog?
let x8 = maybeDog ?? maybeDog ?? maybeDog ?? dog;      // Dog
