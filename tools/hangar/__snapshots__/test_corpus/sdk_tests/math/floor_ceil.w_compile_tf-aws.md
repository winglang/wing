# [floor_ceil.w](../../../../../../examples/tests/sdk_tests/math/floor_ceil.w) | compile | tf-aws

## inflight.$Closure1.js
```js
module.exports = function({ x, math_Util }) {
  class $Closure1 {
    constructor({  }) {
    ...
    async handle()  {
      {((cond) => {if (!cond) throw new Error("assertion failed: math.floor(x) == 3")})(((await math_Util.floor(x)) === 3))};
      {((cond) => {if (!cond) throw new Error("assertion failed: math.ceil(x) == 4")})(((await math_Util.ceil(x)) === 4))};
    }
  }
  return $Closure1;
}
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    const x = 3.41;
    {((cond) => {if (!cond) throw new Error("assertion failed: math.floor(x) == 3")})(((math.Util.floor(x)) === 3))};
    {((cond) => {if (!cond) throw new Error("assertion failed: math.ceil(x) == 4")})(((math.Util.ceil(x)) === 4))};
    this.node.root.new("@winglang/sdk.std.Test",std.Test,this,"test:inflight floor/ceil",new $Closure1(this,"$Closure1"));
  }
}
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "floor_ceil", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
