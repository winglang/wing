# [floor_ceil_round.main.w](../../../../../../examples/tests/sdk_tests/math/floor_ceil_round.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "floor_ceil_round.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
