    ...
    class $Closure1 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure1-1.js")({
            ...
            $population: ${$stdlib.core.Lifting.lift(context, population)},
            $subset: ${$stdlib.core.Lifting.lift(context, subset)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(population, host, []);
          $stdlib.std.Resource._registerBindObject(subset, host, []);
        }
      }
