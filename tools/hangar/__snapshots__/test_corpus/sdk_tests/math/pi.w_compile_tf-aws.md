...
module.exports = function({ circumference, r, math_Util }) {
  class $Closure2 {
    ...
    async handle()  {
      {((cond) => {if (!cond) throw new Error("assertion failed: math.round(circumference(r), 2) == 62.83")})(((await math_Util.round((await circumference(r)),2)) === 62.83))};
    }
  }
  return $Closure2;
}
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: math.round(math.PI, 3) == 3.142")})(((math.Util.round(math.Util.PI,3)) === 3.142))};
