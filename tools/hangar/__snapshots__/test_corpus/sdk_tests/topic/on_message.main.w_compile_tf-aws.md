# [on_message.main.w](../../../../../../examples/tests/sdk_tests/topic/on_message.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "on_message.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
