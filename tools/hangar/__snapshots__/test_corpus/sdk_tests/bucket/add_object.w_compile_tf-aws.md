    ...
    class $Closure1 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure1-1.js")({
            ...
            $jsonObj1: ${$stdlib.core.Lifting.lift(context, jsonObj1)},
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(b, host, ["get", "getJson", "list"]);
          $stdlib.std.Resource._registerBindObject(jsonObj1, host, []);
        }
      }
