# [on_tick.main.w](../../../../../../examples/tests/sdk_tests/schedule/on_tick.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "on_tick.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
