  ...
  "resource": {
    "aws_apigatewayv2_api": {
      "cloudApi_api_2B334D75": {
        ...
        "body": "{\"openapi\":\"3.0.3\",\"paths\":{\"/$default\":{\"x-amazon-apigateway-any-method\":{\"isDefaultRoute\":true,\"x-amazon-apigateway-integration\":{\"payloadFormatVersion\":\"1.0\",\"type\":\"http_proxy\",\"httpMethod\":\"ANY\",\"uri\":\"https://example.com/\"}}},\"/users/{name}\":{\"get\":{\"operationId\":\"get-users/{name}\",\"responses\":{\"200\":{\"description\":\"200 response\",\"content\":{}}},\"parameters\":[{\"name\":\"name\",\"in\":\"path\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"x-amazon-apigateway-integration\":{\"payloadFormatVersion\":\"2.0\",\"type\":\"aws_proxy\",\"httpMethod\":\"POST\",\"uri\":\"${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.arn}\"}}},\"/path/{name}\":{\"get\":{\"operationId\":\"get-path/{name}\",\"responses\":{\"200\":{\"description\":\"200 response\",\"content\":{}}},\"parameters\":[{\"name\":\"name\",\"in\":\"path\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"x-amazon-apigateway-integration\":{\"payloadFormatVersion\":\"2.0\",\"type\":\"aws_proxy\",\"httpMethod\":\"POST\",\"uri\":\"${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.arn}\"}}},\"/users/permission/{name}\":{\"get\":{\"operationId\":\"get-users/permission/{name}\",\"responses\":{\"200\":{\"description\":\"200 response\",\"content\":{}}},\"parameters\":[{\"name\":\"name\",\"in\":\"path\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"x-amazon-apigateway-integration\":{\"payloadFormatVersion\":\"2.0\",\"type\":\"aws_proxy\",\"httpMethod\":\"POST\",\"uri\":\"${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.arn}\"}}},\"/path/{name}/{age}\":{\"get\":{\"operationId\":\"get-path/{name}/{age}\",\"responses\":{\"200\":{\"description\":\"200 response\",\"content\":{}}},\"parameters\":[{\"name\":\"name\",\"in\":\"path\",\"required\":true,\"schema\":{\"type\":\"string\"}},{\"name\":\"age\",\"in\":\"path\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"x-amazon-apigateway-integration\":{\"payloadFormatVersion\":\"2.0\",\"type\":\"aws_proxy\",\"httpMethod\":\"POST\",\"uri\":\"${aws_lambda_function.cloudApi_cloudApi-OnRequest-86898773_701F5CA7.arn}\"}}}}}",
        "name": "api-c895068c",
        "protocol_type": "HTTP"
      }
    },
    ...
    "aws_lambda_permission": {
      "cloudApi_api_permission-GET-2e836e2d_1D868589": {
        ...
        "source_arn": "${aws_apigatewayv2_api.cloudApi_api_2B334D75.execution_arn}/*/GET/users/permission/{name}",
      ...
      "cloudApi_api_permission-GET-4dd27486_DC8C045A": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_apigatewayv2_api.cloudApi_api_2B334D75.execution_arn}/*/GET/path/{name}",
      ...
      "cloudApi_api_permission-GET-9f89597e_FFBE5338": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_apigatewayv2_api.cloudApi_api_2B334D75.execution_arn}/*/GET/users/{name}",
      ...
      "cloudApi_api_permission-GET-f3087603_89DE0E1C": {
        ...
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_apigatewayv2_api.cloudApi_api_2B334D75.execution_arn}/*/GET/path/{name}/{age}",
