...
module.exports = function({ $api_url, $http_DELETE, http_Util }) {
  ...
  class $Closure2 {
    ...
    async handle()  {
      ...
      const fetchResponse = (await http.Util.fetch(url,Object.freeze({"method":$http_DELETE})));
  ...
  constructor(scope, id) {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        const $api_DELETE = context._lift(api_DELETE);
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        ...
        const $http_DELETE = context._lift(http_DELETE);
