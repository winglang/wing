  ...
  "resource": {
    ...
    "aws_lambda_permission": {
      "cloudApi_api_permission-PUT-dcff9e9b_69C95ABF": {
        ...
        "source_arn": "${aws_apigatewayv2_api.cloudApi_api_2B334D75.execution_arn}/*/PUT/path/{id}/nn/{user}",
