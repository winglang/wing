...
module.exports = function({ $api_POST, $body, $std_Json }) {
  class $Closure1 {
    ...
    async handle(req) {
      {((cond) => {if (!cond) throw new Error("assertion failed: req.method == api_POST")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(req.method,$api_POST)))};
...
module.exports = function({ $api_url, $body, $http_POST, $http_Util, $std_Json }) {
  class $Closure2 {
    ...
    async handle() {
      ...
      const fetchResponse = (await $http_Util.post(url,{ method: $http_POST, headers: ({"content-type": "application/json"}), body: ((args) => { return JSON.stringify(args[0], null, args[1]) })([$body]) }));
...
```json
{
  ...
  "resource": {
    ...
    "aws_lambda_permission": {
      "undefined_cloudApi_api_permission-POST-e2131352_D819181E": {
        "//": {
          "metadata": {
            "path": "root/undefined/Default/cloud.Api/api/permission-POST-e2131352",
            "uniqueId": "undefined_cloudApi_api_permission-POST-e2131352_D819181E"
          }
        },
        "action": "lambda:InvokeFunction",
        "function_name": "${aws_lambda_function.undefined_cloudApi_cloudApi-OnRequest-83b2983f_3EFB36ED.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.undefined_cloudApi_api_3000E149.execution_arn}/*/POST/path",
