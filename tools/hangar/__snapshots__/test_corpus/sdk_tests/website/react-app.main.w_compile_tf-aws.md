# [react-app.main.w](../../../../../../examples/tests/sdk_tests/website/react-app.main.w) | compile | tf-aws
...
```json
{
  ...
  "resource": {
    ...
    "aws_s3_object": {
      ...
      "exReactApp_exReactApp-host_File--wingjs_D0499099": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/ex.ReactApp/ex.ReactApp-host/File--wing.js",
            "uniqueId": "exReactApp_exReactApp-host_File--wingjs_D0499099"
          }
        },
        "bucket": "${aws_s3_bucket.exReactApp_exReactApp-host_WebsiteBucket_FE5E163A.bucket}",
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $Closure2._registerBindObject(website.url, host, []);
        }
...
new $App({ outdir: $outdir, name: "react-app.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
