...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
      ...
      static _toInflightType() {
        return `
          require("././inflight.$Closure2-1.cjs")({
            ...
            $preflightVariable: ${$stdlib.core.liftObject(preflightVariable)},
    ...
    const website = this.node.root.new("@winglang/sdk.ex.ReactApp", ex.ReactApp, this, "ex.ReactApp", { projectPath: "./react-website", buildDir: "/build/public", useBuildCommand: true });
