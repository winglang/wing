# [add_row.main.w](../../../../../../examples/tests/sdk_tests/table/add_row.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "add_row.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
