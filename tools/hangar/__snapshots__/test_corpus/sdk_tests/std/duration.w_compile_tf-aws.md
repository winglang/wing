...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    {((cond) => {if (!cond) throw new Error(`assertion failed: '((std.Duration.fromMilliseconds(10)).seconds === $stdlib.std.Duration.fromSeconds(0.01).seconds)'`)})(((std.Duration.fromMilliseconds(10)).seconds === $stdlib.std.Duration.fromSec onds(0.01).seconds))};
