...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
      ...
      static _toInflightType() {
        return `
          require("././inflight.$Closure1-1.cjs")({
            $counterA: ${$stdlib.core.liftObject(counterA)},
          })
        `;
      }
      _toInflight() {
      ...
      static _toInflightType() {
        return `
          require("././inflight.$Closure2-1.cjs")({
            $counterB: ${$stdlib.core.liftObject(counterB)},
          })
        `;
      }
      _toInflight() {
      ...
      static _toInflightType() {
        return `
          require("././inflight.$Closure3-1.cjs")({
            $counterC: ${$stdlib.core.liftObject(counterC)},
          })
        `;
      }
      _toInflight() {
    ...
    const counterA = this.node.root.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "counterA");
    const counterB = this.node.root.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "counterB", { initial: 500 });
    const counterC = this.node.root.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "counterC", { initial: (-198) });
