...
class $Root extends $constructs.Construct {
  constructor(scope, id) {
    ...
    class $Closure1 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure1-1.js")({
            $counterA: ${$stdlib.core.Lifting.lift(context, counterA)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(counterA, host, ["peek"]);
        }
      }
    ...
    class $Closure2 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure2-1.js")({
            $counterB: ${$stdlib.core.Lifting.lift(context, counterB)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(counterB, host, ["peek"]);
        }
      }
      static _registerTypeBind(host, ops) {
      }
    ...
    class $Closure3 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure3-1.js")({
            $counterC: ${$stdlib.core.Lifting.lift(context, counterC)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(counterC, host, ["peek"]);
        }
      }
      static _registerTypeBind(host, ops) {
      }
