# [inc.test.w](../../../../../../examples/tests/sdk_tests/counter/inc.test.w) | test | sim

## stdout.log
```log
[<TIMESTAMP>] [INFO] inc() » root/env0/counter1/Resource
Bundled code (2405 bytes).

[<TIMESTAMP>] [VERBOSE] inc() » root/env0/counter1/Resource
...
[<TIMESTAMP>] [VERBOSE] inc() » root/env0/test:inc()/Handler
root/env0/test:inc()/Handler started

[<TIMESTAMP>] [VERBOSE] inc() » root/env0/test:inc()/Handler
Bundled code (1526 bytes).

[<TIMESTAMP>] [INFO] inc() with custom key » root/env1/counter2/Resource
Bundled code (2406 bytes).

[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/counter2/Resource
Initializing sandbox.
...
[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/test:inc() with custom key/Handler
root/env1/test:inc() with custom key/Handler started
...
[<TIMESTAMP>] [INFO] inc() » root/env0/counter2/Resource
Bundled code (2406 bytes).

[<TIMESTAMP>] [VERBOSE] inc() » root/env0/counter2/Resource
Initializing sandbox.
...
[<TIMESTAMP>] [INFO] inc() with custom key » root/env1/counter1/Resource
Bundled code (2405 bytes).

[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/counter1/Resource
Initializing sandbox.
...
[<TIMESTAMP>] [VERBOSE] inc() » root/env0/counter1/Resource
Sent a message to the sandbox: {"fn":"call","args":["inc",-4]}
...
[<TIMESTAMP>] [VERBOSE] inc() » root/env0/counter1/Resource
Sent a message to the sandbox: {"fn":"call","args":["inc",0]}
...
[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/counter2/Resource
Sent a message to the sandbox: {"fn":"call","args":["inc",5,"custom-key"]}
...
[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/counter2/Resource
Sent a message to the sandbox: {"fn":"call","args":["inc",-4,"custom-key"]}
...
[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/counter2/Resource
Sent a message to the sandbox: {"fn":"call","args":["inc",0,"custom-key"]}
...
[<TIMESTAMP>] [VERBOSE] inc() » root/env0/test:inc()/Handler
root/env0/test:inc()/Handler stopped
...
[<TIMESTAMP>] [VERBOSE] inc() with custom key » root/env1/test:inc() with custom key/Handler
root/env1/test:inc() with custom key/Handler stopped
