...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    class Util extends $stdlib.std.Resource {
      ...
      _supportedOps() {
        return [...super._supportedOps(), "logging", "$inflight_init"];
      }
    }
    ...
    const f1 = this.node.root.new("@winglang/sdk.cloud.Function", cloud.Function, this, "f1", new $Closure1(this, "$Closure1"));
    const f2 = this.node.root.new("@winglang/sdk.cloud.Function", cloud.Function, this, "f2", new $Closure2(this, "$Closure2"));
