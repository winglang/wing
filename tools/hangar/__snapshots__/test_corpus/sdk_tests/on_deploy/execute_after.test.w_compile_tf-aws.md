...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const init1 = this.node.root.new("@winglang/sdk.cloud.OnDeploy", cloud.OnDeploy, this, "init1", new $Closure1(this, "$Closure1"));
    const init2 = this.node.root.new("@winglang/sdk.cloud.OnDeploy", cloud.OnDeploy, this, "init2", new $Closure2(this, "$Closure2"), { executeAfter: [init1] });
