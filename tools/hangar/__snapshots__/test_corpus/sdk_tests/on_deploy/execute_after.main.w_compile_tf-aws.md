# [execute_after.main.w](../../../../../../examples/tests/sdk_tests/on_deploy/execute_after.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "execute_after.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
