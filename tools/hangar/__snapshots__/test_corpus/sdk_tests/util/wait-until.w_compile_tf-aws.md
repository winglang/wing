...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class JSHelper extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.JSHelper-0c2d3284.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-0c2d3284.js")({
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure2-0c2d3284.js")({
            $JSHelper: ${context._lift(JSHelper)},
    ...
    class $Closure3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure3-0c2d3284.js")({
            $JSHelper: ${context._lift(JSHelper)},
    ...
    class $Closure4 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure4-0c2d3284.js")({
            $JSHelper: ${context._lift(JSHelper)},
    ...
    class $Closure5 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure5-0c2d3284.js")({
            $invokeCounter: ${context._lift(invokeCounter)},
            $util_Util: ${context._lift(util.Util)},
          })
        `);
