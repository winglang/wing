    ...
    class $Closure1 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure1-1.js")({
            $NIL: ${$stdlib.core.Lifting.lift(context, NIL)},
            $RANDOM: ${$stdlib.core.Lifting.lift(context, RANDOM)},
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(NIL, host, []);
          $stdlib.std.Resource._registerBindObject(RANDOM, host, []);
        }
      }
