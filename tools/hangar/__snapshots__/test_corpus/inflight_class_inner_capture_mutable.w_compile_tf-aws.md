...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    this.node.root.new("@winglang/sdk.cloud.Test",cloud.Test,this,"test:inner inflight class capture immutable",new $Inflight1(this,"$Inflight1"));
  }
}
