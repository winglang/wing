# [public_url.w](../../../../examples/tests/valid/public_url.w) | compile | tf-aws
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class $Inflight1 extends $stdlib.std.Resource {
      ...
      _registerBind(host, ops) {
        if (ops.includes("$inflight_init")) {
          $Inflight1._registerBindObject(privateBucket, host, []);
          $Inflight1._registerBindObject(publicBucket, host, []);
        }
        if (ops.includes("handle")) {
          $Inflight1._registerBindObject(privateBucket, host, ["publicUrl", "put"]);
          $Inflight1._registerBindObject(publicBucket, host, ["publicUrl", "put"]);
        }
    ...
    this.node.root.new("@winglang/sdk.std.Test",std.Test,this,"test:publicUrl",new $Inflight1(this,"$Inflight1"));
  }
}
