  ...
  constructor($scope, $id) {
    ...
    class $Closure1 extends $stdlib.std.AutoIdResource {
      ...
      get _liftMap() {
        return ({
          "handle": [
            [("bang" in (((arr, index) => { if (index < 0 || index >= arr.length) throw new Error("Index out of bounds"); return arr[index]; })(arrOfMap, 0))), [].concat(...[])],
            [("world" in (myMap)), [].concat(...[])],
            [((arr, index) => { if (index < 0 || index >= arr.length) throw new Error("Index out of bounds"); return arr[index]; })(arr, 0), [].concat(...[])],
            [((arr, index) => { if (index < 0 || index >= arr.length) throw new Error("Index out of bounds"); return arr[index]; })(arr, 1), [].concat(...[])],
            [((obj, args) => { if (obj[args] === undefined) throw new Error(`Json property "${args}" does not exist`); return obj[args] })(j, "b"), [].concat(...[])],
            [(mySet.has("my")), [].concat(...[])],
            [Object.keys(myMap).length, [].concat(...[])],
            [arr.length, [].concat(...[])],
            [mySet.size, [].concat(...[])],
          ],
          "$inflight_init": [
