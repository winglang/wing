...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    class MyClosure extends $stdlib.std.Resource {
      ...
      constructor($scope, $id, ) {
        super($scope, $id);
        this.bucket = $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "cloud.Bucket");
      }
      static _toInflightType() {
        return `
    ...
    const bucket2 = $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "cloud.Bucket");
    const fn = new $Closure1(this, "$Closure1");
    const fn2 = new MyClosure(this, "MyClosure");
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:call synthetic closure class as a function", new $Closure2(this, "$Closure2"));
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:call non-synthetic closure as a function", new $Closure3(this, "$Closure3"));
  }
}
