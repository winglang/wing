# [function_variadic_arguments.main.w](../../../../../examples/tests/valid/function_variadic_arguments.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "function_variadic_arguments.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
