...
## inflight.MyClosure-fe252818.js
```js
module.exports = function({ $bucket2 }) {
  class MyClosure {
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-fe252818.js")({
    ...
    class MyClosure extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.MyClosure-fe252818.js")({
            $bucket2: ${context._lift(bucket2)},
          })
        `);
      }
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure2-fe252818.js")({
            $fn: ${context._lift(fn)},
          })
        `);
      }
    ...
    class $Closure3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure3-fe252818.js")({
            $bucket2: ${context._lift(bucket2)},
