# [json_string_interpolation.main.w](../../../../../examples/tests/valid/json_string_interpolation.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "json_string_interpolation.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
