# [new_capture_static.w](../../../../../examples/tests/valid/new_capture_static.w) | compile | tf-aws
...
module.exports = function({ A }) {
  class $Closure1 {
    ...
    async handle()  {
      {((cond) => {if (!cond) throw new Error(`assertion failed: '((await A.b()) === "my_str")'`)})(((await A.b()) === "my_str"))};
    }
    async $inflight_init()  {
    }
  }
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class A extends $stdlib.std.Resource {
      constructor(scope, id, ) {
        super(scope, id);
        this._addInflightOps("b", "$inflight_init");
        const __parent_this = this;
      }
...
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "new_capture_static", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
