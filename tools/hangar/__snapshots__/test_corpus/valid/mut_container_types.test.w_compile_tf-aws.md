...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr4.at(0) == \"a\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr4.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr4, [0]),"a")))};
