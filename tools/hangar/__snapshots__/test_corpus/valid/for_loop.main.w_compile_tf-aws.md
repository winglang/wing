# [for_loop.main.w](../../../../../examples/tests/valid/for_loop.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "for_loop.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
