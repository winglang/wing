# [super_call.main.w](../../../../../examples/tests/valid/super_call.main.w) | compile | tf-aws

## inflight.$Closure1-1.js
```js
module.exports = function({ $InflightB, $testing_Assert }) {
  class $Closure1 {
    constructor({  }) {
...
```js
module.exports = function({ $extended, $testing_Assert }) {
  class $Closure2 {
    constructor({  }) {
      const $obj = (...args) => this.handle(...args);
      Object.setPrototypeOf($obj, this);
...
new $App({ outdir: $outdir, name: "super_call.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
