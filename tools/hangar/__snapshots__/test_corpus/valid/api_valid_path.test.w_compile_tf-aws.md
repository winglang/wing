  ...
  "resource": {
    ...
    "aws_lambda_permission": {
      "cloudApi_api_permission-GET-08e6e523_5A880468": {
        ...
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/pa-th/{with}/two/{variable_s}/f?bla=5&b=6",
      ...
      "cloudApi_api_permission-GET-28ae85ef_1688C1E0": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/regular/path/{param}",
      ...
      "cloudApi_api_permission-GET-43f8ccb9_8100AD68": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/t/{param}",
      ...
      "cloudApi_api_permission-GET-55df4086_AFDE59CB": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/path/{param}",
      ...
      "cloudApi_api_permission-GET-83a11f17_B40DCB9A": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/path",
      ...
      "cloudApi_api_permission-GET-8d6a8a39_7FDACFF5": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/regular/path",
      ...
      "cloudApi_api_permission-GET-8dfdf611_E63657D8": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/alphanumer1cPa_th",
      ...
      "cloudApi_api_permission-GET-a7795791_E2DC1B63": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/segment1/{param1}/segment2?query1=value1?query2=value2",
      ...
      "cloudApi_api_permission-GET-b171b58d_9FC71DD1": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/segment1/segment2?query=value1&query2=value2",
      ...
      "cloudApi_api_permission-GET-b49a0d1b_4BF20C26": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/{param}",
      ...
      "cloudApi_api_permission-GET-b53ce5f6_5CFB8031": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/param/is/{last}",
      ...
      "cloudApi_api_permission-GET-f2bb7c42_70EF6671": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-cdafee6e_A6C8366F.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/test/path.withDots",
