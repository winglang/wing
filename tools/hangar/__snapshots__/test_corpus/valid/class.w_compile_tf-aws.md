...
## inflight.PaidStudent-c4e3dc82.js
```js
...
## inflight.TeacherAid-c4e3dc82.js
```js
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class C1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.C1-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class C2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.C2-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class C3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.C3-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class C4 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.C4-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class C5 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.C5-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-c4e3dc82.js")({
            $c5: ${context._lift(c5)},
          })
        `);
      }
    ...
    class Person extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Person-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Student extends Person {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Student-c4e3dc82.js")({
    ...
    class PaidStudent extends Student {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.PaidStudent-c4e3dc82.js")({
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure2-c4e3dc82.js")({
    ...
    class TeacherAid extends PaidStudent {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.TeacherAid-c4e3dc82.js")({
    ...
    class $Closure3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure3-c4e3dc82.js")({
    ...
    class A extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.A-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class B extends A {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.B-c4e3dc82.js")({
            $A: ${context._lift(A)},
          })
        `);
      }
    ...
    class $Closure4 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure4-c4e3dc82.js")({
            $B: ${context._lift(B)},
          })
        `);
      }
    ...
    class Bar extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Bar-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Foo extends Bar {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Foo-c4e3dc82.js")({
    ...
    class Baz extends Bar {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Baz-c4e3dc82.js")({
            $Bar: ${context._lift(Bar)},
          })
        `);
      }
    ...
    class Boom extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Boom-c4e3dc82.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Bam extends Boom {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Bam-c4e3dc82.js")({
