...
new $App({ outdir: $outdir, name: "capture_resource_with_no_inflight", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, sourceDir: process.env['WING_SOURCE_DIR'] }).synth();
