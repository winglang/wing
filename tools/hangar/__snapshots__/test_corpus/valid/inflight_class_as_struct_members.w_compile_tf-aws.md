...
module.exports = function(stdStruct) {
  class Bar {
    ...
    static _toInflightType(context) {
      return `require("./Bar.Struct.js")(${ $stdlib.core.Lifting.lift(context, stdStruct) })`;
    }
  }
  return Bar;
};
    ...
    class $Closure2 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure2-1.js")({
            $getBar: ${$stdlib.core.Lifting.lift(context, getBar)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(getBar, host, ["handle"]);
        }
      }
      static _registerTypeBind(host, ops) {
      }
