...
new $App({ outdir: $outdir, name: "inflight_class_as_struct_members", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, sourceDir: process.env['WING_SOURCE_DIR'] }).synth();
