...
new $App({ outdir: $outdir, name: "inflight_class_structural_interace_handler", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, sourceDir: process.env['WING_SOURCE_DIR'] }).synth();
