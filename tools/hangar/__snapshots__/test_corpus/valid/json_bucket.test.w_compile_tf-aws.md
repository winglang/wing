...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const getJson = $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "cloud.Function", new $Closure1(this, "$Closure1"));
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:put", new $Closure2(this, "$Closure2"));
  }
}
