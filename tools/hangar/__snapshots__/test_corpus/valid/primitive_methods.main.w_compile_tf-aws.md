# [primitive_methods.main.w](../../../../../examples/tests/valid/primitive_methods.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "primitive_methods.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
