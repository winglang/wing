...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const counter = $PlatformManager.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "sasa");
    (kv.onUpdate(new $Closure2(this, "$Closure2")));
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:main", new $Closure3(this, "$Closure3"));
  }
}
