# [file_counter.main.w](../../../../../examples/tests/valid/file_counter.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "file_counter.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
