# [table.w](../../../../../examples/tests/valid/table.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "table", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test }).synth();
