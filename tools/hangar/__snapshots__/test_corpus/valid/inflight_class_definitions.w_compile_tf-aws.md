...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class A extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.A-ebf2e1e2.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class B extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.B-ebf2e1e2.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-ebf2e1e2.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class D extends $stdlib.std.Resource {
      constructor(scope, id, ) {
        ...
        class E extends $stdlib.std.Resource {
          ...
          static _toInflightType(context) {
            return $stdlib.core.NodeJsCode.fromInline(`
              require("./inflight.E-ebf2e1e2.js")({
              })
            `);
          }
          _toInflight() {
        ...
        class F extends $stdlib.std.Resource {
          ...
          static _toInflightType(context) {
            return $stdlib.core.NodeJsCode.fromInline(`
              require("./inflight.F-ebf2e1e2.js")({
              })
            `);
          }
          _toInflight() {
        ...
        class $Closure2 extends $stdlib.std.Resource {
          ...
          static _toInflightType(context) {
            return $stdlib.core.NodeJsCode.fromInline(`
              require("./inflight.$Closure2-ebf2e1e2.js")({
                $F: ${context._lift(F)},
              })
            `);
          }
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.D-ebf2e1e2.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure3-ebf2e1e2.js")({
            $B: ${context._lift(B)},
            $a: ${context._lift(a)},
            $d: ${context._lift(d)},
            $fn: ${context._lift(fn)},
