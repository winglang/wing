...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const q = $PlatformManager.new("@winglang/sdk.cloud.Queue", cloud.Queue, this, "cloud.Queue");
    const strToStr = $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "strToStr", new $Closure1(this, "$Closure1"));
    const func = $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "func", new $Closure2(this, "$Closure2"));
  }
}
