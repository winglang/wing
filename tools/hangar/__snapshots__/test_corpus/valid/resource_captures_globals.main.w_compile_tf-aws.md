# [resource_captures_globals.main.w](../../../../../examples/tests/valid/resource_captures_globals.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "resource_captures_globals.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
