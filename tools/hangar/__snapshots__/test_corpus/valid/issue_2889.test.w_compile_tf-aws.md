# [issue_2889.test.w](../../../../../tests/valid/issue_2889.test.w) | compile | tf-aws
      ...
      get _liftMap() {
        return ({
          "handle": [
            ...
            [$stdlib.core.toLiftableModuleType(globalThis.$ClassFactory.resolveType("@winglang/sdk.std.Json") ?? std.Json, "@winglang/sdk/std", "Json"), ["parse"]],
            [api.url, []],
          ],
          "$inflight_init": [
