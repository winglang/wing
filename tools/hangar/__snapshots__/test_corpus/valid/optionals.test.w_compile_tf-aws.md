...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const payloadWithBucket = ({"a": "a", "c": $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "orange bucket")});
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:t", new $Closure1(this, "$Closure1"));
