# [symbol_shadow.main.w](../../../../../examples/tests/valid/symbol_shadow.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "symbol_shadow.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
