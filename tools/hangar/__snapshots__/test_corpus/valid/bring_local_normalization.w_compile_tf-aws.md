  ...
  class Bar extends $stdlib.std.Resource {
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Bar-bd83ea8e.js")({
        })
      `);
    }
    _toInflight() {
...
module.exports = function({ $stdlib }) {
  ...
  class Baz extends $stdlib.std.Resource {
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Baz-dd41d2e9.js")({
        })
      `);
    }
    _toInflight() {
...
module.exports = function({ $stdlib }) {
  ...
  class Foo extends $stdlib.std.Resource {
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Foo-4828c337.js")({
        })
      `);
    }
    _toInflight() {
...
new $App({ outdir: $outdir, name: "bring_local_normalization", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test }).synth();
