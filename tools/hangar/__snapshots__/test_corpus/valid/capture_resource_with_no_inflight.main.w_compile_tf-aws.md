# [capture_resource_with_no_inflight.main.w](../../../../../examples/tests/valid/capture_resource_with_no_inflight.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "capture_resource_with_no_inflight.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
