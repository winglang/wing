# [std_string.main.w](../../../../../examples/tests/valid/std_string.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "std_string.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
