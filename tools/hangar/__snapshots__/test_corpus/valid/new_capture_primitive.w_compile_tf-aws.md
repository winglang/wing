# [new_capture_primitive.w](../../../../../examples/tests/valid/new_capture_primitive.w) | compile | tf-aws

## inflight.$Closure1.js
```js
module.exports = function({ goodbye, s }) {
  class $Closure1 {
    constructor({  }) {
    ...
    async handle()  {
      ...
      {((cond) => {if (!cond) throw new Error(`assertion failed: '(goodbye.length === 7)'`)})((goodbye.length === 7))};
    }
    async $inflight_init()  {
    }
  }
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      _registerBind(host, ops) {
        if (ops.includes("$inflight_init")) {
          $Closure1._registerBindObject(goodbye, host, [""]);
...
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "new_capture_primitive", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
