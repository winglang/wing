  ...
  "resource": {
    "aws_api_gateway_deployment": {
      "A_cloudApi_api_deployment_8CFEA08D": {
        ...
        "rest_api_id": "${aws_api_gateway_rest_api.A_cloudApi_api_apiApi_06FB014D.id}",
        "triggers": {
          "redeployment": "${sha256(aws_api_gateway_rest_api.A_cloudApi_api_apiApi_06FB014D.body)}"
        }
      },
    ...
    "aws_api_gateway_rest_api": {
      "A_cloudApi_api_apiApi_06FB014D": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/A/cloud.Api/api/apiApi",
            "uniqueId": "A_cloudApi_api_apiApi_06FB014D"
          }
        },
      ...
      "A_cloudApi_cloudApi-OnRequest-73c5308f_E645B0BE": {
        ...
        "environment": {
          "variables": {
            ...
            "WING_TARGET": "tf-aws",
            "WING_TOKEN_HTTPS_TFTOKEN_TOKEN_31_EXECUTE_API_TFTOKEN_TOKEN_24_AMAZONAWS_COM_TFTOKEN_TOKEN_32": "${jsonencode(\"https://${aws_api_gateway_rest_api.A_cloudApi_api_apiApi_06FB014D.id}.execute-api.${data.aws_region.Region.name}.amazonaws.com/${aws_api_gateway_stage.A_cloudApi_api_stage_6D822CCE.stage_name}\")}"
          }
        },
    ...
    "aws_lambda_permission": {
      "A_cloudApi_api_permission-GET-1454206f_5CDB71B7": {
        ...
        "source_arn": "${aws_api_gateway_rest_api.A_cloudApi_api_apiApi_06FB014D.execution_arn}/*/GET/endpoint1",
      ...
      "cloudApi_api_permission-GET-ceca4943_9997DB29": {
        ...
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.cloudApi_api_apiApi_FE5ACA2E.execution_arn}/*/GET/hello/world",
