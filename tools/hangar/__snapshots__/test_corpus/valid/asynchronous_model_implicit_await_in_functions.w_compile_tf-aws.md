...
new $App({ outdir: $outdir, name: "asynchronous_model_implicit_await_in_functions", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, sourceDir: process.env['WING_SOURCE_DIR'] }).synth();
