...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const s = ((obj, args) => { if (args[0] < 0 || args[0] >= sArray.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(sArray, [1]);
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: sArray.at(1) == \"two\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= sArray.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(sArray, [1]),"two")))};
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: mergedArray.at(5) == \"will\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= mergedArray.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(mergedArray, [5]),"will")))};
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: mergedMutArray.at(5) == \"that\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= mergedMutArray.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(mergedMutArray, [5]),"that")))};
...
new $App({ outdir: $outdir, name: "std_containers.test", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
