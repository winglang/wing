# [json_static.main.w](../../../../../examples/tests/valid/json_static.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "json_static.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
