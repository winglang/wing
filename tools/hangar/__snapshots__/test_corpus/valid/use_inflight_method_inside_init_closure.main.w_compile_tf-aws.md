# [use_inflight_method_inside_init_closure.main.w](../../../../../examples/tests/valid/use_inflight_method_inside_init_closure.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "use_inflight_method_inside_init_closure.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
