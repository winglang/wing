  ...
  "resource": {
    "aws_api_gateway_deployment": {
      "cloudApi_api_deployment_545514BF": {
        ...
        "triggers": {
          "redeployment": "d5cfebcc5973474c59bd3c32a8bef5db1de2c86c"
        }
      }
    },
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    const api = this.node.root.newAbstract("@winglang/sdk.cloud.Api",this,"cloud.Api",{ cors: ({"origins": ["*"],"methods": [cloud.HttpMethod.GET, cloud.HttpMethod.POST, cloud.HttpMethod.OPTIONS],"headers": ["Content-Type"],"allowCredentials": false,"exposedHeaders": ["Content-Type"]}) });
