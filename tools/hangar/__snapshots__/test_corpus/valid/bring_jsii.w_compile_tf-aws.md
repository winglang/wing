    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-7a7eb511.js")({
...
new $App({ outdir: $outdir, name: "bring_jsii", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test }).synth();
