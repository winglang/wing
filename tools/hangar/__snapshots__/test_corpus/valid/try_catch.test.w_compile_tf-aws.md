...
const $APP = $PlatformManager.createApp({ outdir: $outdir, name: "try_catch.test", rootConstruct: $Root, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'], traceUsage: process.env['WING_TRACE_USAGE'] });
$APP.synth();
