# [capture_reassigable_class_field.main.w](../../../../../examples/tests/valid/capture_reassigable_class_field.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "capture_reassigable_class_field.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
