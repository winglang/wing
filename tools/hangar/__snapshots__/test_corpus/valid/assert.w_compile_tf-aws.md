    ...
    class $Closure1 extends $constructs.Construct {
      ...
      static _toInflightType(context) {
        return `
          require("./inflight.$Closure1-1.js")({
            $s1: ${$stdlib.core.Lifting.lift(context, s1)},
            $s2: ${$stdlib.core.Lifting.lift(context, s2)},
          })
        `;
      }
      _toInflight() {
      ...
      _registerBind(host, ops) {
        if (ops.includes("handle")) {
          $stdlib.std.Resource._registerBindObject(s1, host, []);
          $stdlib.std.Resource._registerBindObject(s2, host, []);
        }
      }
