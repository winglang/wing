# [statements_if.main.w](../../../../../examples/tests/valid/statements_if.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "statements_if.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
