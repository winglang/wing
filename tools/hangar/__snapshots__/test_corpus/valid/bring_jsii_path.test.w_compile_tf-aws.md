# [bring_jsii_path.test.w](../../../../../examples/tests/valid/bring_jsii_path.test.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "bring_jsii_path.test", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
