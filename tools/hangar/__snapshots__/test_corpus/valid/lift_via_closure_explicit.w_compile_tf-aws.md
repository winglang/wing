...
new $App({ outdir: $outdir, name: "lift_via_closure_explicit", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, sourceDir: process.env['WING_SOURCE_DIR'] }).synth();
