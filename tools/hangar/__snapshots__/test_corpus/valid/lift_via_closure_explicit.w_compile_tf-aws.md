...
## inflight.MyClosure-f46c8160.js
```js
  ...
  "resource": {
    ...
    "aws_iam_role_policy": {
      "testtest_Handler_IamRolePolicy_AF0279BD": {
        ...
        "policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":[\"sqs:SendMessage\"],\"Resource\":[\"${aws_sqs_queue.MyClosure_cloudQueue_465FD228.arn}\"],\"Effect\":\"Allow\"}]}",
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class MyClosure extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.MyClosure-f46c8160.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-f46c8160.js")({
            $fn: ${context._lift(fn)},
          })
        `);
      }
...
new $App({ outdir: $outdir, name: "lift_via_closure_explicit", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test }).synth();
