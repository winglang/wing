  ...
  "resource": {
    ...
    "aws_iam_role_policy": {
      "root_testtest_Handler_IamRolePolicy_65A1D8BE": {
        ...
        "policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":[\"sqs:SendMessage\"],\"Resource\":[\"${aws_sqs_queue.root_MyClosure_cloudQueue_52DD99E1.arn}\"],\"Effect\":\"Allow\"}]}",
    ...
    "aws_lambda_function": {
      "root_testtest_Handler_046C3415": {
        ...
        "environment": {
          "variables": {
            "QUEUE_URL_6ec5b2e4": "${aws_sqs_queue.root_MyClosure_cloudQueue_52DD99E1.url}",
    ...
    "aws_sqs_queue": {
      "root_MyClosure_cloudQueue_52DD99E1": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/MyClosure/cloud.Queue/Default",
            "uniqueId": "root_MyClosure_cloudQueue_52DD99E1"
          }
        },
...
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "lift_via_closure_explicit", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
