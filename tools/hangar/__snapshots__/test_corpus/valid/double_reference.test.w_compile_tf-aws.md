...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const initCount = $PlatformManager.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "cloud.Counter");
    const bar = new Bar(this, "Bar");
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:hello", new $Closure1(this, "$Closure1"));
  }
}
