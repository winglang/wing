# [lift_this.main.w](../../../../../examples/tests/valid/lift_this.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "lift_this.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
