  ...
  constructor($scope, $id) {
    ...
    class PreflightClass extends $stdlib.std.Resource {
      ...
      preflight_method() {
        ...
        return $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "cloud.Function", inflight_closure);
      }
      static _toInflightType() {
        return `
    ...
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:it works", new $Closure2(this, "$Closure2"));
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:inflight class inside closure captures from closure", new $Closure3(this, "$Closure3"));
  }
}
