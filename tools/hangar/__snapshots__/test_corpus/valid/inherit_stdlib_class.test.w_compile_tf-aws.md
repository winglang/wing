      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.AnApi-1.cjs")({
            $cloud_Api: ${$stdlib.core.liftObject($stdlib.core.toLiftableModuleType(globalThis.$ClassFactory.resolveType("@winglang/sdk.cloud.Api") ?? cloud.Api, "@winglang/sdk/cloud", "Api"))},
          })
        `;
      }
      _liftedState() {
