...
## inflight.KeyValueStore-0e2e53d3.js
```js
module.exports = function({  }) {
  class KeyValueStore {
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class KeyValueStore extends $stdlib.std.Resource {
        ...
        class $Closure1 extends $stdlib.std.Resource {
          ...
          static _toInflightType(context) {
            return $stdlib.core.NodeJsCode.fromInline(`
              require("./inflight.$Closure1-0e2e53d3.js")({
              })
            `);
          }
          _toInflight() {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.KeyValueStore-0e2e53d3.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure2 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure2-0e2e53d3.js")({
    ...
    class $Closure3 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure3-0e2e53d3.js")({
            $counter: ${context._lift(counter)},
            $kv: ${context._lift(kv)},
