...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const currentFile = (fs.Util.join($helpers.normalPath("../../.."), filename));
    (expect.Util.equal(filename, (fs.Util.basename(currentFile))));
    (expect.Util.equal($helpers.normalPath("../../.."), (fs.Util.dirname(currentFile))));
    (expect.Util.equal((bar.Bar.getSubdir(this)), (fs.Util.join($helpers.normalPath("../../.."), "subdir"))));
    (expect.Util.equal($helpers.normalPath("../../../intrinsics.test.w"), currentFile));
    (expect.Util.equal((fs.Util.dirname(currentFile)), $helpers.normalPath("../../..")));
    (expect.Util.equal((bar.Bar.getSubfile(this)), (fs.Util.join($helpers.normalPath("../../.."), "subdir", "bar.w"))));
  }
}
