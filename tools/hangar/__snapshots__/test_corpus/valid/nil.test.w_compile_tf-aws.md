...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:nil return", new $Closure1(this, "$Closure1"));
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:optional instance variable", new $Closure2(this, "$Closure2"));
  }
}
