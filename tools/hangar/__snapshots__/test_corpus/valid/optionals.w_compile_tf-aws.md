...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class Super extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Super-94069c21.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Sub extends Super {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Sub-94069c21.js")({
    ...
    class Sub1 extends Super {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Sub1-94069c21.js")({
            $Super: ${context._lift(Super)},
          })
        `);
      }
    ...
    class Node extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Node-94069c21.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-94069c21.js")({
