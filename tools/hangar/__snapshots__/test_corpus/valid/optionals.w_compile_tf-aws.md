    ...
    async handle() {
      {
        ((cond) => {
          if (!cond)
            throw new Error(
              "assertion failed: payloadWithoutOptions.b? == false"
            );
        })((payloadWithoutOptions.b != null) === false);
      }
  ...
  constructor(scope, id) {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        ...
        const payloadWithoutOptions_client = context._lift(
    ...
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: x? == true");
      })((x != null) === true);
    }
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: !x? == false");
      })(!(x != null) === false);
    }
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: x ?? 5 == 4");
      })((x ?? 5) === 4);
    }
    const y = x ?? 5;
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: y == 4");
      })(y === 4);
    }
    ...
    {
      ((cond) => {
        if (!cond) throw new Error('assertion failed: s.name == "Super"');
      })(s.name === "Super");
    }
    let name = {
      first: "John",
    ...
    };
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        ...
        {
          ((cond) => {
            if (!cond) throw new Error('assertion failed: n.first == "John"');
          })(n.first === "John");
        }
      }
    }
    name = undefined;
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        ...
        {
          ((cond) => {
            if (!cond) throw new Error("assertion failed: false");
          })(false);
        }
      } else {
        {
          ((cond) => {
            if (!cond) throw new Error("assertion failed: true");
          })(true);
        }
      }
    }
    ...
    };
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        const parsedName = $IF_LET_VALUE;
        {
          ((cond) => {
            if (!cond)
              throw new Error('assertion failed: parsedName.first == "Good"');
          })(parsedName.first === "Good");
        }
        {
          ...
          if ($IF_LET_VALUE != undefined) {
            const lastName = $IF_LET_VALUE;
            {
              ((cond) => {
                if (!cond)
                  throw new Error('assertion failed: lastName == "Name"');
              })(lastName === "Name");
            }
          } else {
            {
      ...
      if ($IF_LET_VALUE != undefined) {
        const parsedName = $IF_LET_VALUE;
        {
          ((cond) => {
            if (!cond)
              throw new Error(
                'assertion failed: parsedName.first == "BadName"'
              );
          })(parsedName.first === "BadName");
        }
        {
          const $IF_LET_VALUE = parsedName.last;
          if ($IF_LET_VALUE != undefined) {
    ...
    const falsy = false;
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        ...
        {
          ((cond) => {
            if (!cond) throw new Error("assertion failed: f == false");
          })(f === false);
        }
      } else {
        {
    ...
    const shadow = "root";
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        ...
        {
          ((cond) => {
            if (!cond) throw new Error('assertion failed: shadow == "root"');
          })(shadow === "root");
        }
        const shadow1 = "nested";
        {
          ...
          if ($IF_LET_VALUE != undefined) {
            const shadow1 = $IF_LET_VALUE;
            {
              ((cond) => {
                if (!cond)
                  throw new Error('assertion failed: shadow1 == "nested"');
              })(shadow1 === "nested");
            }
          } else {
            {
    ...
    {
      ((cond) => {
        if (!cond) throw new Error('assertion failed: fun("hello") == "hello"');
      })(fun("hello") === "hello");
    }
    {
      ((cond) => {
        if (!cond) throw new Error('assertion failed: fun(nil) == "default"');
    ...
    const tree = new Node(
      ...
      new Node(
        ...
        "three",
        3,
        new Node(this, "one", 1, undefined, undefined),
        new Node(this, "six", 6, undefined, undefined)
      ),
      new Node(
        this,
        "ten",
        ...
        new Node(
          ...
          "fourteen",
          14,
          new Node(this, "thirteen", 13, undefined, undefined),
          undefined
        )
      )
    );
    ...
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: thirteen == 13");
      })(thirteen === 13);
    }
    {
      ((cond) => {
        if (!cond) throw new Error("assertion failed: notThere == nil");
      })(notThere === undefined);
    }
    {
      ...
      if ($IF_LET_VALUE != undefined) {
        ...
        {
          ((cond) => {
            if (!cond) throw new Error("assertion failed: o.value == 1");
          })(o.value === 1);
        }
      }
    }
