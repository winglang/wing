...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:super call inflight", new $Closure1(this, "$Closure1"));
    ...
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:super call sets binding permissions", new $Closure2(this, "$Closure2"));
  }
}
