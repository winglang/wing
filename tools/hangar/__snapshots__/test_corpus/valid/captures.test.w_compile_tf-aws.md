...
```json
{
  ...
  "resource": {
    ...
    "aws_cloudwatch_log_group": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_CloudwatchLogGroup_EF1ECEDA": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/CloudwatchLogGroup",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_CloudwatchLogGroup_EF1ECEDA"
          }
        },
        "name": "/aws/lambda/cloud-Api-OnRequest-16664b-c86197e5",
        "retention_in_days": 30
      },
      ...
      "cloudQueue-SetConsumer-677370_CloudwatchLogGroup_A88E9035": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/CloudwatchLogGroup",
            "uniqueId": "cloudQueue-SetConsumer-677370_CloudwatchLogGroup_A88E9035"
          }
        },
        "name": "/aws/lambda/cloud-Queue-SetConsumer-677370-c834366a",
        "retention_in_days": 30
      }
    },
    "aws_iam_role": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_IamRole_F988BE18": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/IamRole",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_IamRole_F988BE18"
          }
        },
        "assume_role_policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"sts:AssumeRole\",\"Principal\":{\"Service\":\"lambda.amazonaws.com\"},\"Effect\":\"Allow\"}]}"
      },
      ...
      "cloudQueue-SetConsumer-677370_IamRole_EA063931": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/IamRole",
            "uniqueId": "cloudQueue-SetConsumer-677370_IamRole_EA063931"
          }
        },
        "assume_role_policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"sts:AssumeRole\",\"Principal\":{\"Service\":\"lambda.amazonaws.com\"},\"Effect\":\"Allow\"}]}"
      }
    ...
    "aws_iam_role_policy": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_IamRolePolicy_0F7C8784": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/IamRolePolicy",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_IamRolePolicy_0F7C8784"
          }
        },
        "policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Action\":\"none:null\",\"Resource\":\"*\"}]}",
        "role": "${aws_iam_role.cloudApi_cloudApi-OnRequest-16664b_IamRole_F988BE18.name}"
      },
      ...
      "cloudQueue-SetConsumer-677370_IamRolePolicy_3A0A9FED": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/IamRolePolicy",
            "uniqueId": "cloudQueue-SetConsumer-677370_IamRolePolicy_3A0A9FED"
          }
        },
        ...
        "role": "${aws_iam_role.cloudQueue-SetConsumer-677370_IamRole_EA063931.name}"
      }
    },
    "aws_iam_role_policy_attachment": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_IamRolePolicyAttachment_F680FEE8": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/IamRolePolicyAttachment",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_IamRolePolicyAttachment_F680FEE8"
          }
        },
        "policy_arn": "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole",
        "role": "${aws_iam_role.cloudApi_cloudApi-OnRequest-16664b_IamRole_F988BE18.name}"
      ...
      "cloudQueue-SetConsumer-677370_IamRolePolicyAttachment_7155FA42": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/IamRolePolicyAttachment",
            "uniqueId": "cloudQueue-SetConsumer-677370_IamRolePolicyAttachment_7155FA42"
          }
        },
        "policy_arn": "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole",
        "role": "${aws_iam_role.cloudQueue-SetConsumer-677370_IamRole_EA063931.name}"
    ...
    "aws_lambda_event_source_mapping": {
      "cloudQueue_EventSourceMapping_41814136": {
        ...
        "function_name": "${aws_lambda_function.cloudQueue-SetConsumer-677370.function_name}"
      }
    },
    "aws_lambda_function": {
      "AnotherFunction": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_59D4F2C6": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/Default",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_59D4F2C6"
          }
        },
        "architectures": [
          "arm64"
        ...
        "environment": {
          "variables": {
            "NODE_OPTIONS": "--enable-source-maps",
            "WING_FUNCTION_NAME": "cloud-Api-OnRequest-16664b-c86197e5",
            "WING_TARGET": "tf-aws"
          }
        },
        "function_name": "cloud-Api-OnRequest-16664b-c86197e5",
        "handler": "index.handler",
        "memory_size": 1024,
        "publish": true,
        "role": "${aws_iam_role.cloudApi_cloudApi-OnRequest-16664b_IamRole_F988BE18.arn}",
        "runtime": "nodejs18.x",
        "s3_bucket": "${aws_s3_bucket.Code.bucket}",
        "s3_key": "${aws_s3_object.cloudApi_cloudApi-OnRequest-16664b_S3Object_5CB479B2.key}",
        "timeout": 60,
        "vpc_config": {
          "security_group_ids": [],
          "subnet_ids": []
      ...
      "cloudQueue-SetConsumer-677370": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/Default",
            "uniqueId": "cloudQueue-SetConsumer-677370"
          }
        },
        "architectures": [
          "arm64"
        ...
        "environment": {
          "variables": {
            ...
            "BUCKET_NAME_d755b447": "${aws_s3_bucket.cloudBucket.bucket}",
            "NODE_OPTIONS": "--enable-source-maps",
            "WING_FUNCTION_NAME": "cloud-Queue-SetConsumer-677370-c834366a",
            "WING_TARGET": "tf-aws"
          }
        },
        "function_name": "cloud-Queue-SetConsumer-677370-c834366a",
        "handler": "index.handler",
        "memory_size": 1024,
        "publish": true,
        "role": "${aws_iam_role.cloudQueue-SetConsumer-677370_IamRole_EA063931.arn}",
        "runtime": "nodejs18.x",
        "s3_bucket": "${aws_s3_bucket.Code.bucket}",
        "s3_key": "${aws_s3_object.cloudQueue-SetConsumer-677370_S3Object_54C7AF72.key}",
    ...
    "aws_lambda_permission": {
      "cloudApi_api_permission-GET-df16733f_0EEF8FF5": {
        ...
        "function_name": "${aws_lambda_function.cloudApi_cloudApi-OnRequest-16664b_59D4F2C6.function_name}",
    ...
    "aws_s3_object": {
      ...
      "cloudApi_cloudApi-OnRequest-16664b_S3Object_5CB479B2": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Api/cloud.Api-OnRequest-16664b/S3Object",
            "uniqueId": "cloudApi_cloudApi-OnRequest-16664b_S3Object_5CB479B2"
          }
        },
        "bucket": "${aws_s3_bucket.Code.bucket}",
        "key": "<ASSET_KEY>",
      ...
      "cloudQueue-SetConsumer-677370_S3Object_54C7AF72": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/cloud.Queue-SetConsumer-677370/S3Object",
            "uniqueId": "cloudQueue-SetConsumer-677370_S3Object_54C7AF72"
          }
        },
        "bucket": "${aws_s3_bucket.Code.bucket}",
        "key": "<ASSET_KEY>",
