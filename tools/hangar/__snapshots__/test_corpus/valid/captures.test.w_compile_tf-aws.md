...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const bucket1 = $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "cloud.Bucket");
    const bucket2 = $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "PublicBucket", ({"public": true}));
    const bucket3 = $PlatformManager.new("@winglang/sdk.cloud.Bucket", cloud.Bucket, this, "PrivateBucket", { public: false });
    ...
    $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "cloud.Function", handler, { env: ({}) });
    const emptyEnv = ({});
    $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "AnotherFunction", handler, { env: emptyEnv });
