# [capture_reassignable.w](../../../../../examples/tests/valid/capture_reassignable.w) | test | sim

## stdout.log
```log
fail ┌ capture_reassignable.wsim » root/env0/test:main
     │ ReferenceError: handler is not defined
     │     at $Closure2.handle (/tmp/wing-bundles-lXBjfZ/index.js:14:11)
     │     at exports.handler (/tmp/wing-bundles-lXBjfZ/index.js:34:9)
