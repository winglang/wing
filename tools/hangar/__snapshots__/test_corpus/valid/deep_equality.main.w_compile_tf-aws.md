# [deep_equality.main.w](../../../../../examples/tests/valid/deep_equality.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "deep_equality.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
