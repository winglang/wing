...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    super($scope, $id);
    const app = $PlatformManager.new("cdk8s.App", cdk8s.App, );
    const chart = $PlatformManager.new("cdk8s.Chart", cdk8s.Chart, this, "cdk8s.Chart");
    const deploy = ($scope => $PlatformManager.new("cdk8s-plus-27.Deployment", kplus.Deployment, $scope, "kplus.Deployment"))(chart);
