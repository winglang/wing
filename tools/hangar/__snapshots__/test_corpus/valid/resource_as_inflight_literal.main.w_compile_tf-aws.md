# [resource_as_inflight_literal.main.w](../../../../../examples/tests/valid/resource_as_inflight_literal.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "resource_as_inflight_literal.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
