...
[INFO] testing Redis | 65e8ba9473fe: Waiting
585124038cab: Waiting
b483de716a47: Waiting
[INFO] testing Redis | 241c2d338588: Verifying Checksum
241c2d338588: Download complete
[INFO] testing Redis | 89515d93a23e: Verifying Checksum
[INFO] testing Redis | 89515d93a23e: Download complete
...
[INFO] testing Redis | b483de716a47:
[INFO] testing Redis | Verifying Checksum
...
[INFO] testing Redis | 1:C <TIMESTAMP> <TIMESTAMP> # oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
1:C <TIMESTAMP> <TIMESTAMP> # Redis version=7.0.9, bits=64, commit=00000000, modified=0, pid=1, just started
1:C <TIMESTAMP> <TIMESTAMP> # Warning: no config file specified, using the default config. In order to specify a config file use redis-server <ABSOLUTE>/redis.conf
1:M <TIMESTAMP> <TIMESTAMP> * monotonic clock: POSIX clock_gettime
1:M <TIMESTAMP> <TIMESTAMP> * Running mode=standalone, port=6379.
1:M <TIMESTAMP> <TIMESTAMP> # Server initialized
1:M <TIMESTAMP> <TIMESTAMP> # WARNING Memory overcommit must be enabled! Without it, a background save or replication may fail under low memory condition. Being disabled, it can can also cause failures without low memory condition, see https://github.com/jemalloc/jemalloc/issues/1328. To fix this issue add 'vm.overcommit_memory = 1' to <ABSOLUTE>/sysctl.conf and then reboot or run the command 'sysctl vm.overcommit_memory=1' for this to take effect.
1:M <TIMESTAMP> <TIMESTAMP> * Ready to accept connections
[INFO] testing Redis | Container redis@sha256:e50c7e23f79ae81351beacb20e004720d4bed657415e68c2b1a2b5557c075ce0 started
[INFO] testing Redis | 1:C <TIMESTAMP> <TIMESTAMP> # oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
1:C <TIMESTAMP> <TIMESTAMP> # Redis version=7.0.9, bits=64, commit=00000000, modified=0, pid=1, just started
1:C <TIMESTAMP> <TIMESTAMP> # Warning: no config file specified, using the default config. In order to specify a config file use redis-server <ABSOLUTE>/redis.conf
