...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class A extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.A-86ac99a7.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-86ac99a7.js")({
            $x: ${context._lift(x)},
          })
        `);
      }
    ...
    class r extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.r-86ac99a7.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Dog extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Dog-86ac99a7.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Terrier extends Dog {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Terrier-86ac99a7.js")({
