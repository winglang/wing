...
module.exports = function({ $bucket }) {
  class $Closure2 {
    ...
    async handle() {
      $helpers.assert($helpers.eq((await $bucket.list()).length, 0), "Bucket should be empty", "bucket.list().length == 0, \"Bucket should be empty\"");
    }
  }
  return $Closure2;
}
...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    globalThis.$ClassFactory.new("@winglang/sdk.std.Test", std.Test, this, "test:test1", new $Closure1(this, "$Closure1"));
    globalThis.$ClassFactory.new("@winglang/sdk.std.Test", std.Test, this, "test:test2", new $Closure2(this, "$Closure2"));
  }
}
