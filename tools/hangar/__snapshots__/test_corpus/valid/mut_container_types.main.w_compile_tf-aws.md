# [mut_container_types.main.w](../../../../../examples/tests/valid/mut_container_types.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "mut_container_types.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
