...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr1.at(1) == 2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr1.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr1, [1]),2)))};
    const arr2 = ["1", "2", "3"];
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr2.at(1) == \"2\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr2.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr2, [1]),"2")))};
    const arr3 = [1, 2, 3];
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr3.at(1) == 2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr3.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr3, [1]),2)))};
    const arr4 = [1, 2, 3];
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr4.at(1) == 2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr4.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr4, [1]),2)))};
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr5.at(1) == bucket2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr5.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr5, [1]),bucket2)))};
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr6.at(1) == bucket2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr6.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr6, [1]),bucket2)))};
    const arr7 = arr4;
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: arr7.at(1) == 2")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= arr7.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(arr7, [1]),2)))};
    {
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.keys().at(0) == \"a\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m8), [0]),"a")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.keys().at(1) == \"b\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m8), [1]),"b")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.keys().at(2) == \"c\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m8), [2]),"c")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.values().at(0) == \"a1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m8), [0]),"a1")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.values().at(1) == \"b1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m8), [1]),"b1")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m8.values().at(2) == \"c1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m8).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m8), [2]),"c1")))};
    ...
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.keys().at(0) == \"a\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m9), [0]),"a")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.keys().at(1) == \"b\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m9), [1]),"b")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.keys().at(2) == \"c\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.keys(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.keys(m9), [2]),"c")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.values().at(0) == \"a1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m9), [0]),"a1")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.values().at(1) == \"b1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m9), [1]),"b1")))};
    {((cond) => {if (!cond) throw new Error("assertion failed: m9.values().at(2) == \"c1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(((obj, args) => { if (args[0] < 0 || args[0] >= Object.values(m9).length) throw new Error("Index out of bounds"); return obj[args[0]]; })(Object.values(m9), [2]),"c1")))};
...
new $App({ outdir: $outdir, name: "container_types.test", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
