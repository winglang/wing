...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const counter = globalThis.$PolyconFactory.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "Counter", { initial: 100 });
...
const $APP = $PlatformManager.createApp({ outdir: $outdir, name: "file_counter.test", rootConstruct: $Root, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'], polyconFactory: globalThis.$PolyconFactory });
$APP.synth();
