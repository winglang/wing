...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const usersTable = this.node.root.new("@winglang/sdk.ex.Table", ex.Table, this, "ex.Table", { name: "users-table", primaryKey: "id", columns: (() => { let m = {}; 
      m["id"] = ex.ColumnType.STRING;
      m["name"] = ex.ColumnType.STRING;
      m["age"] = ex.ColumnType.NUMBER;
      return m;
    })() });
