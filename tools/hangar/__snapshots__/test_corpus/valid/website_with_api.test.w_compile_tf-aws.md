  ...
  "resource": {
    ...
    "aws_s3_object": {
      ...
      "cloudWebsite_File-configjson_591A81BA": {
        ...
        "bucket": "${aws_s3_bucket.cloudWebsite_WebsiteBucket_EB03D355.bucket}",
        "content": "{\"apiUrl\":\"https://${aws_api_gateway_rest_api.cloudApi_api_2B334D75.id}.execute-api.${data.aws_region.Region.name}.amazonaws.com/prod\"}",
