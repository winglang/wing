# [bring_cdk8s.main.w](../../../../../examples/tests/valid/bring_cdk8s.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "bring_cdk8s.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
