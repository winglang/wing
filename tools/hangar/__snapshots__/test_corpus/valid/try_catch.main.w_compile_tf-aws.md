# [try_catch.main.w](../../../../../examples/tests/valid/try_catch.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "try_catch.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
