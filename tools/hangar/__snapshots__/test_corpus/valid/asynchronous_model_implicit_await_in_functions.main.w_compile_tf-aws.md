# [asynchronous_model_implicit_await_in_functions.main.w](../../../../../examples/tests/valid/asynchronous_model_implicit_await_in_functions.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "asynchronous_model_implicit_await_in_functions.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
