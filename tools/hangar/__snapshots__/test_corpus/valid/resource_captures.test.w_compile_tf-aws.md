      ...
      get _liftMap() {
        return ({
          ...
          "testCaptureCollectionsOfData": [
            [(!(this.setOfStr.has("s3"))), [].concat(...[])],
            [((arr, index) => { if (index < 0 || index >= arr.length) throw new Error("Index out of bounds"); return arr[index]; })(this.arrayOfStr, 0), [].concat(...[])],
            [((arr, index) => { if (index < 0 || index >= arr.length) throw new Error("Index out of bounds"); return arr[index]; })(this.arrayOfStr, 1), [].concat(...[])],
            [((obj, key) => { if (!(key in obj)) throw new Error(`Map does not contain key: "${key}"`); return obj[key]; })(this.mapOfNum, "k1"), [].concat(...[])],
            [((obj, key) => { if (!(key in obj)) throw new Error(`Map does not contain key: "${key}"`); return obj[key]; })(this.mapOfNum, "k2"), [].concat(...[])],
            [(this.setOfStr.has("s1")), [].concat(...[])],
            [(this.setOfStr.has("s2")), [].concat(...[])],
            [this.arrayOfStr.length, [].concat(...[])],
          ],
          ...
          "testExpressionRecursive": [
            [this.myQueue, [].concat(...[["push"]])],
            [this.myStr, [].concat(...[])],
          ],
          "testExternal": [
            [this.extBucket, [].concat(...[["list"]])],
            [this.extNum, [].concat(...[])],
          ],
          ...
          "$inflight_init": [
            ...
            [(this.setOfStr.has("s2")), [].concat(...[])],
            [this.another, [].concat(...[])],
            [this.another.first.myResource, [].concat(...[])],
            [this.another.myField, [].concat(...[])],
            [this.arrayOfStr.length, [].concat(...[])],
            [this.extBucket, [].concat(...[])],
            [this.extNum, [].concat(...[])],
            [this.myBool, [].concat(...[])],
            [this.myNum, [].concat(...[])],
            [this.myOptStr, [].concat(...[])],
            [this.myQueue, [].concat(...[])],
            [this.myResource, [].concat(...[])],
            [this.myStr, [].concat(...[])],
          ],
          "inflightField": [
          ],
