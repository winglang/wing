...
module.exports = function({  }) {
  class MyResource {
    constructor({ $___this_setOfStr_has__s3____, $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k1__, $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k2__, $_this_arrayOfStr_at_0__, $_this_arrayOfStr_at_1__, $_this_myOptStr_______, $_this_setOfStr_has__s1___, $_this_setOfStr_has__s2___, $this_another, $this_another_first_myResource, $this_another_myField, $this_arrayOfStr_length, $this_extBucket, $this_extNum, $this_myBool, $this_myNum, $this_myQueue, $this_myResource, $this_myStr }) {
      this.$___this_setOfStr_has__s3____ = $___this_setOfStr_has__s3____;
      this.$__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k1__ = $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k1__;
      this.$__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k2__ = $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k2__;
    ...
    async testCaptureCollectionsOfData() {
      ...
      {((cond) => {if (!cond) throw new Error("assertion failed: this.mapOfNum.get(\"k1\") == 11")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(this.$__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k1__,11)))};
      {((cond) => {if (!cond) throw new Error("assertion failed: this.mapOfNum.get(\"k2\") == 22")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(this.$__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k2__,22)))};
    ...
    class MyResource extends $stdlib.std.Resource {
        ...
        return `
          (await (async () => {
            ...
            const client = new MyResourceClient({
              ...
              $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k1__: ${this._lift(((obj, args) => { if (obj[args] === undefined) throw new Error(`Object does not contain the key "${args}"`); return obj[args] })(this.mapOfNum, "k1"))},
              $__obj__args_______if__obj_args______undefined__throw_new_Error__Object_does_not_contain_the_key____args______return_obj_args_____this_mapOfNum___k2__: ${this._lift(((obj, args) => { if (obj[args] === undefined) throw new Error(`Object does not contain the key "${args}"`); return obj[args] })(this.mapOfNum, "k2"))},
      ...
      _registerBind(host, ops) {
        if (ops.includes("$inflight_init")) {
          ...
          MyResource._registerBindObject(((obj, args) => { if (obj[args] === undefined) throw new Error(`Object does not contain the key "${args}"`); return obj[args] })(this.mapOfNum, "k1"), host, []);
          MyResource._registerBindObject(((obj, args) => { if (obj[args] === undefined) throw new Error(`Object does not contain the key "${args}"`); return obj[args] })(this.mapOfNum, "k2"), host, []);
