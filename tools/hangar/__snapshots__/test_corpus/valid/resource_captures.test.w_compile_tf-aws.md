...
module.exports = function({  }) {
  class MyResource {
    constructor({ $___this_setOfStr_has__s3____, $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___0__, $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___1__, $__obj__key_______if____key_in_obj___throw_new_Error__Map_does_not_contain_key_____key______return_obj_key______this_mapOfNum___k1__, $__obj__key_______if____key_in_obj___throw_new_Error__Map_does_not_contain_key_____key______return_obj_key______this_mapOfNum___k2__, $_this_myOptStr_______, $_this_setOfStr_has__s1___, $_this_setOfStr_has__s2___, $this_another, $this_another_first_myResource, $this_another_myField, $this_arrayOfStr_length, $this_extBucket, $this_extNum, $this_myBool, $this_myNum, $this_myQueue, $this_myResource, $this_myStr }) {
      this.$___this_setOfStr_has__s3____ = $___this_setOfStr_has__s3____;
      this.$__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___0__ = $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___0__;
      this.$__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___1__ = $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___1__;
    ...
    async testCaptureCollectionsOfData() {
      ...
      {((cond) => {if (!cond) throw new Error("assertion failed: this.arrayOfStr.at(0) == \"s1\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(this.$__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___0__,"s1")))};
      {((cond) => {if (!cond) throw new Error("assertion failed: this.arrayOfStr.at(1) == \"s2\"")})((((a,b) => { try { return require('assert').deepStrictEqual(a,b) === undefined; } catch { return false; } })(this.$__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___1__,"s2")))};
    ...
    class MyResource extends $stdlib.std.Resource {
        ...
        return `
          (await (async () => {
            ...
            const client = new MyResourceClient({
              ...
              $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___0__: ${this._lift(((obj, args) => { if (args[0] < 0 || args[0] >= this.arrayOfStr.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(this.arrayOfStr, [0]))},
              $__obj__args_______if__args_0____0____args_0_____this_arrayOfStr_length__throw_new_Error__Index_out_of_bounds____return_obj_args_0_______this_arrayOfStr___1__: ${this._lift(((obj, args) => { if (args[0] < 0 || args[0] >= this.arrayOfStr.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(this.arrayOfStr, [1]))},
      ...
      _registerOnLift(host, ops) {
        if (ops.includes("$inflight_init")) {
          ...
          MyResource._registerOnLiftObject(((obj, args) => { if (args[0] < 0 || args[0] >= this.arrayOfStr.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(this.arrayOfStr, [0]), host, []);
          MyResource._registerOnLiftObject(((obj, args) => { if (args[0] < 0 || args[0] >= this.arrayOfStr.length) throw new Error("Index out of bounds"); return obj[args[0]]; })(this.arrayOfStr, [1]), host, []);
...
new $App({ outdir: $outdir, name: "resource_captures.test", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
