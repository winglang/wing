# [extern_implementation.main.w](../../../../../examples/tests/valid/extern_implementation.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "extern_implementation.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
