# [website_with_api.main.w](../../../../../examples/tests/valid/website_with_api.main.w) | compile | tf-aws
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    const api = this.node.root.newAbstract("@winglang/sdk.cloud.Api",this,"cloud.Api",{ cors: true, corsOptions: ({"allowOrigin": ["*"],"allowMethods": [cloud.HttpMethod.GET, cloud.HttpMethod.POST, cloud.HttpMethod.OPTIONS],"allowHeaders": ["Content-Type"],"allowCredentials": false,"exposeHeaders": ["Content-Type"],"maxAge": 600}) });
...
new $App({ outdir: $outdir, name: "website_with_api.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
