...
## inflight.MyClosure-c56caae9.js
```js
...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class MyClosure extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.MyClosure-c56caae9.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-c56caae9.js")({
            $fn: ${context._lift(fn)},
          })
        `);
      }
...
new $App({ outdir: $outdir, name: "closure_class", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test }).synth();
