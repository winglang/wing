  ...
  constructor($scope, $id) {
    ...
    class Doubler2 extends $stdlib.std.Resource {
      ...
      makeFunc(handler) {
        ...
        return $PlatformManager.new("@winglang/sdk.cloud.Function", cloud.Function, this, "cloud.Function", new $Closure2(this, "$Closure2"));
      }
      static _toInflightType() {
        return `
    ...
    $PlatformManager.new("@winglang/sdk.std.Test", std.Test, this, "test:f(2) == 8", new $Closure4(this, "$Closure4"));
  }
}
