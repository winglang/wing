# [new_capture_enum.w](../../../../../examples/tests/valid/new_capture_enum.w) | compile | tf-aws
...
module.exports = function({ Goo }) {
  class $Closure1 {
    ...
    async handle()  {
      {((cond) => {if (!cond) throw new Error(`assertion failed: '(Goo.A !== Goo.B)'`)})((Goo.A !== Goo.B))};
    }
    async $inflight_init()  {
    }
  }
  ...
  constructor(scope, id) {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        const GooClient = $stdlib.core.NodeJsCode.fromInline(`
...
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "new_capture_enum", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
