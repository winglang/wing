...
class $Root extends $stdlib.std.Resource {
  constructor(scope, id) {
    ...
    class $Closure1 extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.$Closure1-3cbbf6f9.js")({
    ...
    class Triangle extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Triangle-3cbbf6f9.js")({
          })
        `);
      }
      _toInflight() {
    ...
    class Util extends $stdlib.std.Resource {
      ...
      static _toInflightType(context) {
        return $stdlib.core.NodeJsCode.fromInline(`
          require("./inflight.Util-3cbbf6f9.js")({
          })
        `);
      }
      _toInflight() {
...
module.exports = function({ $stdlib }) {
  ...
  class Util extends $stdlib.std.Resource {
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Util-25318830.js")({
        })
      `);
    }
    _toInflight() {
  ...
  class Store extends $stdlib.std.Resource {
    constructor(scope, id, ) {
      ...
      class $Closure1 extends $stdlib.std.Resource {
        ...
        static _toInflightType(context) {
          return $stdlib.core.NodeJsCode.fromInline(`
            require("./inflight.$Closure1-25318830.js")({
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Store-25318830.js")({
        })
      `);
    }
    _toInflight() {
...
module.exports = function({ $stdlib }) {
  ...
  class Q extends $stdlib.std.Resource {
    ...
    static _toInflightType(context) {
      return $stdlib.core.NodeJsCode.fromInline(`
        require("./inflight.Q-aa96061e.js")({
        })
      `);
    }
    _toInflight() {
