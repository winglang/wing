# [call_static_of_myself.main.w](../../../../../examples/tests/valid/call_static_of_myself.main.w) | compile | tf-aws
...
new $App({ outdir: $outdir, name: "call_static_of_myself.main", rootConstruct: $Root, plugins: $plugins, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] }).synth();
