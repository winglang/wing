# [main.w](../../../../../../../examples/tests/doc_examples/valid/00-cloud-oriented-programming.md_example_1/main.w) | compile | tf-aws
...
module.exports = function({ $bucket, $counter }) {
  class $Closure1 {
    ...
    async handle(body) {
      ...
      const key = String.raw({ raw: ["myfile-", ".txt"] }, next);
...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    const queue = this.node.root.new("@winglang/sdk.cloud.Queue", cloud.Queue, this, "Queue", { timeout: (std.Duration.fromSeconds(120)) });
