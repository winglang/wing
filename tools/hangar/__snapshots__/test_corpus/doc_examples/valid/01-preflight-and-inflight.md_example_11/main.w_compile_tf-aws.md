# [main.w](../../../../../../../examples/tests/doc_examples/valid/01-preflight-and-inflight.md_example_11/main.w) | compile | tf-aws
...
module.exports = function({ $api_url, $http_Util }) {
  class $Closure2 {
    ...
    async handle() {
      const url = $api_url;
      const path = String.raw({ raw: ["", "/test"] }, url);
      const response = (await $http_Util.get(path));
  ...
  "resource": {
    ...
    "aws_api_gateway_rest_api": {
      "Api_api_91C07D84": {
        ...
        "body": "{\"paths\":{\"/test\":{\"get\":{\"operationId\":\"get-test\",\"responses\":{\"200\":{\"description\":\"200 response\",\"content\":{}}},\"parameters\":[],\"x-amazon-apigateway-integration\":{\"uri\":\"arn:aws:apigateway:${data.aws_region.Region.name}:lambda:path/2015-03-31/functions/arn:aws:lambda:${data.aws_region.Region.name}:${data.aws_caller_identity.account.account_id}:function:get_test0-c80d158d/invocations\",\"type\":\"aws_proxy\",\"httpMethod\":\"POST\",\"responses\":{\"default\":{\"statusCode\":\"200\"}},\"passthroughBehavior\":\"when_no_match\",\"contentHandling\":\"CONVERT_TO_TEXT\"}}},\"/{proxy+}\":{\"x-amazon-apigateway-any-method\":{\"produces\":[\"application/json\"],\"x-amazon-apigateway-integration\":{\"type\":\"mock\",\"requestTemplates\":{\"application/json\":\"\\n                {\\\"statusCode\\\": 404}\\n              \"},\"passthroughBehavior\":\"never\",\"responses\":{\"404\":{\"statusCode\":\"404\",\"responseParameters\":{\"method.response.header.Content-Type\":\"'application/json'\"},\"responseTemplates\":{\"application/json\":\"{\\\"statusCode\\\": 404, \\\"message\\\": \\\"Error: Resource not found\\\"}\"}},\"default\":{\"statusCode\":\"404\",\"responseParameters\":{\"method.response.header.Content-Type\":\"'application/json'\"},\"responseTemplates\":{\"application/json\":\"{\\\"statusCode\\\": 404, \\\"message\\\": \\\"Error: Resource not found\\\"}\"}}}},\"responses\":{\"404\":{\"description\":\"404 response\",\"headers\":{\"Content-Type\":{\"type\":\"string\"}}}}}}},\"openapi\":\"3.0.3\"}",
        "lifecycle": {
          "create_before_destroy": true
        },
        "name": "api-c8f613f0"
    ...
    "aws_cloudwatch_log_group": {
      "Api_get_test0_CloudwatchLogGroup_48B84BF5": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/CloudwatchLogGroup",
            "uniqueId": "Api_get_test0_CloudwatchLogGroup_48B84BF5"
          }
        },
        "name": "/aws/lambda/get_test0-c80d158d",
    ...
    "aws_iam_role": {
      "Api_get_test0_IamRole_DDB72C48": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/IamRole",
            "uniqueId": "Api_get_test0_IamRole_DDB72C48"
          }
        },
    ...
    "aws_iam_role_policy": {
      "Api_get_test0_IamRolePolicy_C5E2F72C": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/IamRolePolicy",
            "uniqueId": "Api_get_test0_IamRolePolicy_C5E2F72C"
          }
        },
        "policy": "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Action\":\"none:null\",\"Resource\":\"*\"}]}",
        "role": "${aws_iam_role.Api_get_test0_IamRole_DDB72C48.name}"
      },
    ...
    "aws_iam_role_policy_attachment": {
      "Api_get_test0_IamRolePolicyAttachment_52FE9E1B": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/IamRolePolicyAttachment",
            "uniqueId": "Api_get_test0_IamRolePolicyAttachment_52FE9E1B"
          }
        },
    ...
    "aws_lambda_function": {
      "Api_get_test0_81C0B018": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/Default",
            "uniqueId": "Api_get_test0_81C0B018"
          }
        },
        "architectures": [
          "arm64"
        ...
        "environment": {
          "variables": {
            ...
            "WING_FUNCTION_NAME": "get_test0-c80d158d",
            "WING_TARGET": "tf-aws"
          }
        },
        "function_name": "get_test0-c80d158d",
        "handler": "index.handler",
        "memory_size": 1024,
        "publish": true,
        "role": "${aws_iam_role.Api_get_test0_IamRole_DDB72C48.arn}",
        "runtime": "nodejs20.x",
        "s3_bucket": "${aws_s3_bucket.Code.bucket}",
        "s3_key": "${aws_s3_object.Api_get_test0_S3Object_2423BBC5.key}",
        "timeout": 60,
        "vpc_config": {
          "security_group_ids": [],
          "subnet_ids": []
    ...
    "aws_lambda_permission": {
      "Api_api_permission-GET-e8d09b4f_B5D93635": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/api/permission-GET-e8d09b4f",
            "uniqueId": "Api_api_permission-GET-e8d09b4f_B5D93635"
          }
        },
        "action": "lambda:InvokeFunction",
        "function_name": "${aws_lambda_function.Api_get_test0_81C0B018.function_name}",
        "principal": "apigateway.amazonaws.com",
        "source_arn": "${aws_api_gateway_rest_api.Api_api_91C07D84.execution_arn}/*/GET/test",
    ...
    "aws_s3_object": {
      "Api_get_test0_S3Object_2423BBC5": {
        "//": {
          "metadata": {
            "path": "root/Default/Default/Api/get_test0/S3Object",
            "uniqueId": "Api_get_test0_S3Object_2423BBC5"
          }
        },
...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
    ...
    (api.get("/test", new $Closure1(this, "$Closure1")));
    const checkEndpoint = new $Closure2(this, "$Closure2");
    this.node.root.new("@winglang/sdk.cloud.Function", cloud.Function, this, "Function", checkEndpoint);
  }
}
