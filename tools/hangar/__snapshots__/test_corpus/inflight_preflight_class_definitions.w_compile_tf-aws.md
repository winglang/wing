# [inflight_preflight_class_definitions.w](../../../../examples/tests/valid/inflight_preflight_class_definitions.w) | compile | tf-aws
...
class $App extends $AppBase {
  constructor() {
    super({ outdir: $outdir, name: "inflight_preflight_class_definitions", plugins: $plugins, isTestEnvironment: $wing_is_test });
    if ($wing_is_test) {
      new $Root(this, "env0");
