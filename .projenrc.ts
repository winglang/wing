...
monorepo.addScript(
  "package:ci",
  "turbo default --color --concurrency 1 && turbo package --color --summarize && tar -czvf dist/docs.tgz docs/*",
);
monorepo.addScript(
  "test:ci",
  "turbo compile post-compile lint eslint test test:playwright --color --filter=!hangar --summarize",
);
