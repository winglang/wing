...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [14] = {
    ...
    [sym_preflight_closure] = STATE(198),
    [sym_inflight_closure] = STATE(198),
    [sym_await_expression] = STATE(198),
    [sym_defer_expression] = STATE(198),
    [sym_parenthesized_expression] = STATE(198),
    [sym__collection_literal] = STATE(198),
    [sym_array_literal] = STATE(198),
    [sym_set_literal] = STATE(198),
    [sym_map_literal] = STATE(198),
    [sym_struct_literal] = STATE(198),
    [sym_structured_access_expression] = STATE(198),
    [sym_json_literal] = STATE(198),
