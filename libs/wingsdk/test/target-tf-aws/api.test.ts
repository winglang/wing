...
test("api url can be used as environment variable", () => {
  ...
  expect(
    ...
    "https://${aws_api_gateway_rest_api.Api_api_apiApi_912D2960.id}.execute-api.${data.aws_region.Region.name}.amazonaws.com/${aws_api_gateway_stage.Api_api_stage_E0FA39D6.stage_name}"
  );
});
