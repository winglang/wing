...
(0, vitest_1.test)("captures tokens", function () {
    // GIVEN
    var app = new tfaws.App({ outdir: (0, util_1.mkdtemp)(), entrypointDir: __dirname });
    var api = new target_tf_aws_1.Api(app, "Api");
    var numVar = new cdktf_1.TerraformVariable(app, "Number", {
        type: "Number",
        default: 123,
    });
    var listVar = new cdktf_1.TerraformVariable(app, "List", {
        type: "List<Number>",
        default: [1, 2, 3],
    });
    var handler = (0, core_1.lift)({
        str: api.url,
...
(0, vitest_1.test)("captures tokens inside plain objects", function () {
    // GIVEN
    var app = new tfaws.App({ outdir: (0, util_1.mkdtemp)(), entrypointDir: __dirname });
    var api = new target_tf_aws_1.Api(app, "Api");
    var numVar = new cdktf_1.TerraformVariable(app, "Number", {
