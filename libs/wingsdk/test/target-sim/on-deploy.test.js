...
var INFLIGHT_CODE = (0, core_1.inflight)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, console.log("super duper success")];
}); }); });
(0, vitest_1.test)("create an OnDeploy", function () { return __awaiter(void 0, void 0, void 0, function () {
    var app, s, messages;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                s = _a.sent();
                // THEN
                (0, vitest_1.expect)(s.getResourceConfig("/my_on_deploy")).toEqual({
                    attrs: {
                    ...
                    policy: [],
                    props: {
                        functionHandle: vitest_1.expect.any(String),
                    },
            ...
            case 2:
                ...
                messages = (0, util_1.listMessages)(s);
                (0, vitest_1.expect)(messages).toMatchSnapshot();
                (0, vitest_1.expect)(messages).toContain("super duper success");
                return [2 /*return*/];
        }
    });
}); });
