...
function expectExecToBe(fn: SpyInstance, cmd: any, port?: number) {
...
window.wingEnv = {};`);
    ...
    expectExecToBe(execMock, "npm run build");
  });
...
window.wingEnv = {
  ...
  test("running React App on dev mode", async () => {
    ...
    expectExecToBe(execMock, "npm run start", 3001);
  });
  ...
  test("running React App on dev mode on custom port", async () => {
    ...
    expectExecToBe(execMock, "npm run start", 4032);
  });
  ...
  test("running React App on dev mode with custom command", async () => {
    ...
    expectExecToBe(execMock, CUSTOM_COMMAND, 3001);
  });
...
window.wingEnv = {};`);
    ...
    expectExecToBe(execMock, CUSTOM_COMMAND);
  });
