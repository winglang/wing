...
(0, vitest_1.test)("basic function with environment variables", function () {
    ...
    var output = app.synth();
    // THEN
    (0, vitest_1.expect)(cdktf.Testing.toHaveResourceWithProperties(output, "azurerm_linux_function_app", {
        app_settings: {
            BOOM: "BAM",
            FOO: "BAR",
        },
...
(0, vitest_1.test)("permissions resources are added to function after constructor has been initialized", function () {
    // GIVEN
    var app = new tfazure.App({
        outdir: (0, util_1.mkdtemp)(),
        location: "East US",
    ...
    var func = new tfazure.Function(app, "Function", INFLIGHT_CODE, {});
    // WHEN
    ...
    var output = app.synth();
    // THEN
    (0, vitest_1.expect)(cdktf.Testing.toHaveResourceWithProperties(output, "azurerm_role_assignment", {
...
(0, vitest_1.test)("replace invalid character from function name", function () {
    ...
    // WHEN
    var func = new cloud_1.Function(app, "someFunction01", INFLIGHT_CODE);
    var output = app.synth();
    // THEN
    (0, vitest_1.expect)(cdktf.Testing.toHaveResourceWithProperties(output, "azurerm_linux_function_app", {
        name: "somefunction01-".concat(func.node.addr.substring(0, 8)),
    })).toEqual(true);
    (0, vitest_1.expect)((0, util_1.tfSanitize)(output)).toMatchSnapshot();
    (0, vitest_1.expect)((0, util_1.treeJsonOf)(app.outdir)).toMatchSnapshot();
});
