...
var counter_1 = require("../../src/target-tf-azure/counter");
...
(0, vitest_1.test)("default counter behavior", function () {
    var app = new tfAzure.App(__assign({ outdir: (0, util_1.mkdtemp)() }, appProps));
...
(0, vitest_1.test)("function with a counter binding", function () {
    ...
    new cloud.Function(app, "Function", (0, core_1.lift)({ my_counter: counter })
...
(0, vitest_1.test)("inc() policy statement", function () {
    ...
    var output = app.synth();
    (0, vitest_1.expect)(output).toContain(counter_1.StorageAccountPermissions.READ_WRITE);
    (0, vitest_1.expect)((0, util_1.tfSanitize)(output)).toMatchSnapshot();
    (0, vitest_1.expect)((0, util_1.treeJsonOf)(app.outdir)).toMatchSnapshot();
});
...
(0, vitest_1.test)("peek() policy statement", function () {
    ...
    var output = app.synth();
    (0, vitest_1.expect)(output).toContain(counter_1.StorageAccountPermissions.READ);
    (0, vitest_1.expect)((0, util_1.tfSanitize)(output)).toMatchSnapshot();
    (0, vitest_1.expect)((0, util_1.treeJsonOf)(app.outdir)).toMatchSnapshot();
});
(0, vitest_1.test)("set() policy statement", function () {
    ...
    new cloud.Function(app, "Function", (0, core_1.lift)({ my_counter: counter })
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.my_counter.set(12)];
                case 1:
                    val = _a.sent();
                    console.log(val);
                    return [2 /*return*/];
...
(0, vitest_1.test)("counter name valid", function () {
    // GIVEN
    var app = new tfAzure.App(__assign({ outdir: (0, util_1.mkdtemp)() }, appProps));
    var counter = new cloud.Counter(app, "wingcounter");
    var output = app.synth();
    // THEN
    (0, vitest_1.expect)(cdktf.Testing.toHaveResourceWithProperties(output, "azurerm_storage_table", {
        name: "wingcounterx".concat(counter.node.addr.substring(0, 8)),
    })).toEqual(true);
    (0, vitest_1.expect)((0, util_1.tfSanitize)(output)).toMatchSnapshot();
    (0, vitest_1.expect)((0, util_1.treeJsonOf)(app.outdir)).toMatchSnapshot();
});
(0, vitest_1.test)("replace invalid character from counter name", function () {
    ...
    // THEN
    (0, vitest_1.expect)(cdktf.Testing.toHaveResourceWithProperties(output, "azurerm_storage_table", {
        name: "thexamazingxcounterx01x".concat(counter.node.addr.substring(0, 8)),
    })).toEqual(true);
    (0, vitest_1.expect)((0, util_1.tfSanitize)(output)).toMatchSnapshot();
    (0, vitest_1.expect)((0, util_1.treeJsonOf)(app.outdir)).toMatchSnapshot();
});
