...
var CODE_LOG_EVENT = (0, core_1.inflight)(function (_, event) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, console.log("Received: ", event)];
}); }); });
(0, vitest_1.test)("create a schedule", function () {
    // GIVEN
    var app = new tfgcp.App(__assign({ outdir: (0, util_1.mkdtemp)() }, GCP_APP_OPTS));
    var schedule = new cloud_1.Schedule(app, "Schedule", {
        rate: std_1.Duration.fromMinutes(2),
    });
